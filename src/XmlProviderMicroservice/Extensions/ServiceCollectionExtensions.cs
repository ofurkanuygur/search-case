...
using XmlProviderMicroservice.Mapping;
using XmlProviderMicroservice.Models;
using XmlProviderMicroservice.Services;
using Polly;
using Polly.Extensions.Http;
using SearchCase.Contracts.Mapping;
using SearchCase.Contracts.Validators;

namespace XmlProviderMicroservice.Extensions;
...
public static class ServiceCollectionExtensions
{
        ...
        this IServiceCollection services)
    {
        ...
        // Add mapper
        services.AddScoped<IContentMapper<Item>, XmlToCanonicalMapper>();

        // Add validators
        services.AddScoped<IValidator<SearchCase.Contracts.Models.CanonicalVideoContent>, CanonicalVideoContentValidator>();
        services.AddScoped<IValidator<SearchCase.Contracts.Models.CanonicalArticleContent>, CanonicalArticleContentValidator>();
