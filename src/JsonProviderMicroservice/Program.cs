...
using JsonProviderMicroservice.Extensions;
using Serilog;
...
try
{
    Log.Information("Starting JSON Provider Microservice");
    ...
    builder.Services.AddSwaggerGen(options =>
    {
        ...
        {
            Title = "JSON Provider Microservice API",
            Version = "v1",
            Description = "Microservice for fetching and serving data from external JSON provider in canonical format",
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "JSON Provider API v1");
        options.RoutePrefix = "swagger";
        options.DocumentTitle = "JSON Provider API";
    });
    ...
    Log.Information("JSON Provider Microservice configured successfully");
